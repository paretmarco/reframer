...
export default function ClientSection() {
  ...
  const prompt = `Q: ${input} Generate a convincing clever response on the point with less than 600 characters.`;
  ...
  return (
    <div className="w-full max-w-xl">
      <textarea
        ...
        placeholder={"e.g. How I could afford that if I have no money?"}
      />
      {!loading ? (
        <button
